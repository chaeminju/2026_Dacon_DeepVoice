...
# 🚀 **Model Spotlight: MMS-1B-AntiDeepfake**

# 🌟 **Key Features**
- **Architecture**: Wav2Vec 2.0 - [`facebook/mms-1b`](https://huggingface.co/facebook/mms-1b) 🔗.
...
model = DeepfakeDetector.from_pretrained("nii-yamagishilab/mms-1b-anti-deepfake")
model.to(device)
model.eval()
...
|----------------------|---------|----------|-----------|--------|----------|-------|-------|----------------------|
| ADD2023              | 0.969   | 0.931    | 0.946     | 0.961  | 0.954    | 0.155 | 0.039 | 9.06 @ 0.8657        |
| DeepVoice            | 0.997   | 0.964    | 0.781     | 0.979  | 0.869    | 0.038 | 0.021 | 2.47 @ 0.7302        |
| FakeOrReal           | 0.999   | 0.987    | 0.988     | 0.985  | 0.987    | 0.011 | 0.015 | 1.23 @ 0.4813        |
| FakeOrReal-norm      | 0.998   | 0.981    | 0.991     | 0.969  | 0.980    | 0.008 | 0.031 | 1.73 @ 0.3717        |
| In-the-Wild          | 0.998   | 0.967    | 0.995     | 0.951  | 0.973    | 0.007 | 0.049 | 1.82 @ 0.1116        |
| Deepfake-Eval-2024   | 0.807   | 0.741    | 0.753     | 0.900  | 0.820    | 0.559 | 0.100 | 27.70 @ 0.9925       |
...
|--------------|---------|----------|-----------|--------|----------|-------|-------|----------------------|
| 4s           | 0.949   | 0.865    | 0.943     | 0.846  | 0.892    | 0.098 | 0.154 | 12.11 @ 0.2966       |
| 10s          | 0.961   | 0.882    | 0.953     | 0.861  | 0.905    | 0.080 | 0.139 | 10.40 @ 0.2094       |
| 13s          | 0.963   | 0.887    | 0.956     | 0.867  | 0.909    | 0.074 | 0.134 | 10.02 @ 0.2488       |
| 30s          | 0.967   | 0.905    | 0.958     | 0.891  | 0.924    | 0.071 | 0.109 | 8.60 @ 0.2999        |
| 50s          | 0.968   | 0.904    | 0.951     | 0.896  | 0.923    | 0.081 | 0.104 | 9.35 @ 0.3619        |
