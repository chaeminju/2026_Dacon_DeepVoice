#!/usr/bin/env python3
"""external_data/voice_only_500 500개 클립에 대해 PANNs VOICE/MUSIC_PRESENT_PROB를 계산한다.
전처리는 calibrate_presence_thresholds.py의 baseline과 동일한 함수를 그대로 재사용한다."""
...
MANIFEST_PATH = BASE_DIR / "external_data" / "voice_only_500" / "manifest.csv"
RESULTS_CSV = BASE_DIR / "output" / "voice_only_500_probabilities.csv"
