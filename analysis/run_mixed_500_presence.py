#!/usr/bin/env python3
"""external_data/mixed_500 500개 클립에 대해 PANNs VOICE/MUSIC_PRESENT_PROB를 계산한다."""
...
MANIFEST_PATH = BASE_DIR / "external_data" / "mixed_500" / "manifest.csv"
RESULTS_CSV = BASE_DIR / "output" / "mixed_500_probabilities.csv"
